...
public class Emergency 
{
	...
	public void Emergencyall() throws InterruptedException, IOException
	{
		...
		System.out.println("TEST CASE : Verify Emergency Request Are Working Suceccessfully Or Not");
		...
		driver.findElement(By.id("txtusername")).sendKeys("rana");
		driver.findElement(By.id("txtpassword")).sendKeys("rana123");
		Thread.sleep(4000);
