...
public class Healthposttostore {
	...
	public void Healthpost() throws InterruptedException, IOException 
	{
		...
		System.out.println(" ");
		System.out.println("HEALTHPOST TO STORE REQUEST");
		System.out.println("=============================");
		System.out.println(" ");
	...
	@AfterMethod
	public void screen(ITestResult HealthpostTestResult) throws IOException {
		if(HealthpostTestResult.getStatus()==(ITestResult.FAILURE))
		{
		File src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(src, new File("E:\\Jenkins output\\Healthpoststore\\"+date1+"" + HealthpostTestResult.getName() +Arrays.toString(HealthpostTestResult.getParameters()) + ".png"));
