...
public class LabTestEntry {
	...
	String[] PSname={"ganeshkumar","ravi"};
	...
	public  void op() throws InterruptedException, FileNotFoundException 
	{
		...
		System.out.println("TEST CASE : Verify Lab Test Entry Are Working Suceccessfully Or Not");
		...
		driver.findElement(By.id("txtusername")).sendKeys("manoj");
...
Thread.sleep(4000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id='example1']/tbody/tr[1]/td[1]/a")).click();
