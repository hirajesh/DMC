...
public class DMSTOCMS {

	
	WebDriver driver;
	
//	WebDriver driver = new FirefoxDriver();
	Seleniumbaseclass base = new Seleniumbaseclass(driver);
	...
	public void Run() throws InterruptedException, IOException {
		...
		System.out.println("Verify DMS TO CMS Request Working Suceccessfully Or Not");
	...
	public void Addto_Stock() throws InterruptedException 
	{
		...
		driver.findElement(By.xpath("//*[@id='grndetails_filter']/label/input")).sendKeys(CMS_Requestnumber);
		Thread.sleep(500);
	    driver.findElement(By.xpath("/html/body/form/div[3]/aside[2]/section/div/div[2]/div/table/tbody/tr/td[7]")).click();
		Thread.sleep(3000);
		...
		try {
			for(int q=1;q<=add;q++)
			{
			    ...
			    try {
			    	Thread.sleep(2000);
					driver.findElement(By.xpath("/html/body/form/div[3]/aside[2]/section/div/div[4]/div/div/div[2]/div/div/table/tbody/tr[1]/td[6]/input")).click();
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
					Thread.sleep(2000);
